...
[![scaladex](https://img.shields.io/badge/scalaindex-log--effect-orange.svg)](https://index.scala-lang.org/laserdisc-io/log-effect)
...
| --------------- | -----:| -----:| -----------:| ------:|
| log-effect-core | 0.1.5 | 1.1.0 | 0.10.1      | 1.6.1  |

<br>

|                 |       | Fs2    | Log Effect Core   |
| --------------- | -----:| ------:| -----------------:|
| log-effect-fs2  | 0.1.5 | 0.10.5 | 0.1.5             |
